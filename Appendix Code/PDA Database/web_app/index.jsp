                        ...
                        <div class="navigation">
                            <ul>
                                ...
                                <form action="LoginCheck.jsp" method="post">
                                    ...
                                    <a href="index.jsp"></a>
                                    <input id="Username" class="" type="Username" spellcheck="false" value="" placeholder="Username" name="username">
                                    </input>
                                    <label class="hidden-label" for=""></label>
                                    <input id="Password" class="" type="password" spellcheck="false" value="" placeholder="Password" name="password">
                                    </input>

                                    <input id="login" type="submit" value="Log in" style="width:60px;height: 28px">
