...
<html>
    ...
    <body>
        ...
        <input id="Firstname" class="" type="firstname" spellcheck="false" value="" placeholder="Enter your first name" name="firstname" style="position: absolute; top: 25%; left: 44%;" size="25">
        </input>
        ...
        <input id="Password" class="" type="password" spellcheck="false" value="" placeholder="Enter your password" name="firstname" style="position: absolute; top: 55%; left: 44%;" size="25">
        </input>
        <a id="confirm" href=""><center>Confirm</center></a>
        <td>
